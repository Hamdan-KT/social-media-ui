...
import { getFollowerUsers, getMutualUsers, getUsers } from "src/api/userAPI";
...
function MutualRel() {
	...
	const {
		...
		queryKey: ["get-mutual-users"],
		queryFn: ({ pageParam = 1 }) => getMutualUsers(uid, {}, pageParam, 10),
		initialPageParam: 1,
