...
import CommentList from "src/components/ui-components/CommentList";
import Picker from "@emoji-mart/react";
import ReactIcons from "utils/ReactIcons";
import emojiData from "@emoji-mart/data";
import Slide from "src/components/common/Carousel/Slide";
import Slider from "src/components/common/Carousel/Carousel";
	...
	return (
		...
		>
			<Box
				...
				sx={{ position: "relative", width: "max-content", bgcolor: "green" }}
			>
				{likes.map((like) => (
					<motion.div
						key={like.id}
